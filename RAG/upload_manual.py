...
if __name__ == "__main__":
    PDF_FILE_PATH = "MFL67658585.pdf"                     # 로컬 PDF 경로
    MODEL_ID = "F24WD"                                   # device_models.model_id
    MANUAL_TITLE = "세탁기 상세 매뉴얼"
    MANUAL_VERSION = "v1.0"
    FILE_URL = "https://your-bucket/manuals/F24_manual.pdf"  # 실제 경로로 변경
